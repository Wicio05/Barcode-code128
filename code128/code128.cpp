...
void Code128::setCode(std::string code) { str = code; }
...
int Code128::patternBit(int _char) { return code128_pattern[_char - 32]; }
...
void Code128::setImgPadding(int padding) { img_padding = padding; }
